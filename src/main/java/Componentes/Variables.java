...
public class Variables {
    ...
    public int getAvaibleServer(){
      ...
      public String printStatus(){
         String ret="";
         for(int i=0;i<l_SS.size();i++){
             ret=ret+" S"+i+":"+this.l_SS.get(i)+" ";
          };
         return ret; 
      }
    
      public void printVariables(){
          System.out.println("-----VARIABLES DEL SISTEMA-----");
          System.out.println("TM:"+this.TM+" "+this.printStatus()+" WL:"+this.WL+" CantClientes:"+this.cant_clientes);
         
          
      }
      
      public String stringVariables(){
         return "TM:"+Integer.toString(this.TM)+" "+this.printStatus()+" WL:"+Integer.toString(this.WL)+" CantClientes:"+Integer.toString(this.cant_clientes);
